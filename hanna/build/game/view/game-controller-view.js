...
},{"./KeyEscapeUtils":10,"./ReactCurrentOwner":17,"./ReactElement":19,"./getIteratorFn":30,"./reactProdInvariant":32,"_process":9,"fbjs/lib/invariant":3,"fbjs/lib/warning":7}],34:[function(require,module,exports){
'use strict';
...
},{"./tile":38}],38:[function(require,module,exports){
"use strict";
...
},{"./item":36}],40:[function(require,module,exports){
'use strict';
...
var Camera = function (_React$Component) {
  ...
  _createClass(Camera, [{
    key: 'canMove',
    value: function canMove(coordinates) {
      // coordinates = [x, y]
    ...
    value: function render() {
      ...
      tiles.forEach(function (tile) {
        jsx_content.push(_react2.default.createElement(_tileView.Tile_View, {
          ...
          hasPlayer: _underscore2.default.isEqual(tile.position, playerPosition) ? true : false
        }));
      });

      jsx_content.push(_react2.default.createElement(_playerView.Player_View, { key: 'player', player: this.props.player }));
...
},{"./../logic/level/map-utils/map":37,"./../logic/player":39,"./player-view":42,"./tile-view":43,"react":34,"underscore":35}],41:[function(require,module,exports){
'use strict';
...
},{"../logic/level/map-utils/map":37,"../logic/player":39,"./camera-view":40,"react":34}],42:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.Player_View = undefined;
...
var Player_View = function (_React$Component) {
	_inherits(Player_View, _React$Component);

	function Player_View(props) {
		_classCallCheck(this, Player_View);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Player_View).call(this, props));
	...
	_createClass(Player_View, [{
		...
		key: 'render',
		value: function render() {
			return _react2.default.createElement('div', { style: this.getStyles(), className: 'player' });
		}
	}]);
...
},{"../logic/player":39,"react":34}],43:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.Tile_View = undefined;
...
var Tile_View = function (_React$Component) {
	...
	function Tile_View(props) {
		_classCallCheck(this, Tile_View);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Tile_View).call(this, props));

		_this.position = props.position;
		_this.artFile = props.artFile;
...
},{"./../logic/level/map-utils/tile":38,"react":34}]},{},[41]);
